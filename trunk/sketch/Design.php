    ...
    <div role="tabpanel" class="tab-pane active" id="design-shelf">
      <div class="upper-shelf">
        ...
        <div class="upper-shelf">
          ...
          <button class="geo-button icon-exit" data-toggle="tooltip" data-placement="bottom" title="Home" id="btn-home"></button>
        </div>
      </div>
    </div>
  ...
  <div id="canvas-area">
    ...
    <div id="panel-color" style="width: 200px;">
        ...
        <form id="member-profile-form" method="POST">
          ...
          <br>
          <div class="form-group">
            <div id="recommend-color-3" class="recommend-color"></div>
          </div>
