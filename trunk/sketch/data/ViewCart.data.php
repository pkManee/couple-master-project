...
function insertOrder(){
  ...
  $sql = 'insert into shirt_order (email, line_screen_1, line_screen_2, line_screen_price_1, line_screen_price_2, shirt_id_1, ';
  $sql .= 'shirt_id_2, qty_1, qty_2, order_date, order_status, tracking_id ';
  $sql .= 'values ';
  ...
  $stmt->bindValue(":order_status", $_POST["order_status"]);
