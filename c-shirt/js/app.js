...
//					compress: 0.7, // float between 0-1 [jpeg option]
		...
		hosts: { // paths to POST and GET and various servers
			"localhost": { // your localhost
				HOST: "localhost/sketch.io/sketch-basic/www/",
				GET: "localhost/sketch.io/sketch-basic/www/filesystem.php?sketch=",
				POST: "localhost/sketch.io/sketch-basic/www/filesystem.php",
				alias: [ "192.168.0.3", "mud.local" ] // aliases for host setup
			},
			"yourserver.com": { // your server
				HOST: "yourserver.com/",
				GET: "yourserver.com/get/",
				POST: "yourserver.com/save/"
			}
		}
	});
